...
void initialize() {
	...
	leftWing.set_brake_mode(pros::E_MOTOR_BRAKE_HOLD);
...
void competition_initialize() {
	...
	if(autonState == 1) {
		pros::lcd::clear_line(1);
		pros::lcd::set_text(1, "Right side front auton");
	}
	if(autonState == 2) {
		pros::lcd::clear_line(1);
		pros::lcd::set_text(1, "Left side front auton");
	}
	if(autonState == 3) {
		pros::lcd::clear_line(1);
		pros::lcd::set_text(1, "Right side 40pt");
	}
	if(autonState == 4) {
		pros::lcd::clear_line(1);
		pros::lcd::set_text(1, "Left side 40pt");
	}
}
